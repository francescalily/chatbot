...
import { MainContainer, ChatContainer, MessageList, Message, Avatar, MessageInput, TypingIndicator } from '@chatscope/chat-ui-kit-react'
import './styles.css'
...
const handleButtonClicked = async (question) => {
  ...
  return (
    <>
    <div className="mainDiv" style={{ display: "flex", position: "relative", height: "650px", width: "320px"}}>
        <MainContainer style={{  borderRadius: "35px"}} >
            <ChatContainer>
    ...
    {showButton && <Buttons onButtonClicked={handleButtonClicked}/>}
                ...
                <MessageInput style={{borderTop: "none"}}attachButton={false} placeholder='Type your response...' onSend={handleSend}/>
            </ChatContainer>
